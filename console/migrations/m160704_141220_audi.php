...
class m160704_141220_audi extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%pastor}}', [
            ...
            'pos_code' => $this->string(25),
            'handphone' => $this->string(100),
            'home_phone' => $this->string(100),
        ...
        $this->createTable('{{%ministry}}', [
            ...
            'ownership_id' => $this->smallInteger()->notNull()->defaultValue(1),
            ...
            'pastor_status_id' => $this->smallInteger()->notNull()->defaultValue(1),
            'remark' => $this->text(),
